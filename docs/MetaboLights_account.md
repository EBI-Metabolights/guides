...
3. If the email is valid, user will be asked to send password reset link to the email. Once user clicks yes,  a password reset email is sent to the user's inbox.
...
After completing these steps, you will be redirected to the MetaboLights online editor.
...
12. After successful login, you will be taken to the MetaboLights online editor.
